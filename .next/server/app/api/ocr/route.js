...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var _google_cloud_vision__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @google-cloud/vision */ \"(rsc)/./node_modules/@google-cloud/vision/build/src/index.js\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fs */ \"fs\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! path */ \"path\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n\n\n\n\n// ✅ Set credentials from your saved vision-key.json\nprocess.env.GOOGLE_APPLICATION_CREDENTIALS = path__WEBPACK_IMPORTED_MODULE_2___default().join(process.cwd(), \"vision-key.json\");\nasync function POST(req) {\n    try {\n        const { filePath } = await req.json();\n        // 🔒 Validate\n        if (!filePath) {\n            return next_server__WEBPACK_IMPORTED_MODULE_3__.NextResponse.json({\n                error: \"No filePath provided\"\n            }, {\n                status: 400\n            });\n        }\n        // ✅ If file in public folder → create absolute path\n        const absolutePath = path__WEBPACK_IMPORTED_MODULE_2___default().join(process.cwd(), \"public\", filePath);\n        if (!fs__WEBPACK_IMPORTED_MODULE_1___default().existsSync(absolutePath)) {\n            return next_server__WEBPACK_IMPORTED_MODULE_3__.NextResponse.json({\n                error: \"File not found\"\n            }, {\n                status: 400\n            });\n        }\n        // ✅ Init Google Vision\n        const client = new _google_cloud_vision__WEBPACK_IMPORTED_MODULE_0__[\"default\"].ImageAnnotatorClient();\n        // OCR the Aadhaar sample\n        const [result] = await client.textDetection(absolutePath);\n        const detections = result.textAnnotations;\n        if (!detections || detections.length === 0) {\n            return next_server__WEBPACK_IMPORTED_MODULE_3__.NextResponse.json({\n                error: \"No text detected\"\n            }, {\n                status: 404\n            });\n        }\n        // ✅ Extract the full detected text\n        const fullText = detections[0].description;\n        // Return only numbers (Aadhaar style)\n        const digits = fullText.replace(/\\D/g, \"\");\n        const match = digits.match(/\\d{12}/);\n        const aadhaarNum = match ? match[0].replace(/(\\d{4})(?=\\d)/g, \"$1 \").trim() : \"\";\n        return next_server__WEBPACK_IMPORTED_MODULE_3__.NextResponse.json({\n            text: fullText,\n            aadhaar: aadhaarNum\n        });\n    } catch (err) {\n        console.error(\"OCR API error:\", err);\n        return next_server__WEBPACK_IMPORTED_MODULE_3__.NextResponse.json({\n            error: err.message\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/ocr/route.js\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Focr%2Froute&page=%2Fapi%2Focr%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Focr%2Froute.js&appDir=C%3A%5Cprojects%5Chvloan-llm%5Capp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=C%3A%5Cprojects%5Chvloan-llm&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
